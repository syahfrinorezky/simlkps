...
class CreateEmploymentLocations extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            "lokal" => ["type" => "INT", "constraint" => 11, "default" => 0],
            "nasional" => ["type" => "INT", "constraint" => 11, "default" => 0],
            "internasional" => ["type" => "INT", "constraint" => 11, "default" => 0],
        ...
        $this->forge->createTable("employment_locations");
    
    }

    public function down()
    {
        $this->forge->dropTable('employment_locations');
    }
}
