    ...
    <div x-show="detailOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs" x-transition x-cloak>
        <div class="bg-white rounded-3xl max-w-2xl w-full overflow-hidden shadow-2xl border border-slate-100" @click.outside="detailOpen = false">
            <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
                <h3 class="text-lg font-bold text-slate-900 tracking-tight">Detail Dosen Tidak Tetap</h3>
            ...
            <div class="p-6 space-y-4 max-h-[70vh] overflow-y-auto text-sm">
                ...
                <div class="border-t border-slate-100 pt-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <span class="text-slate-400 block text-xs font-semibold uppercase tracking-wider font-bold">Pendidikan Pascasarjana</span>
                        <span class="font-semibold text-slate-700" x-text="detailData.pendidikan_pascasarjana || '-'"></span>
                    </div>
                    <div>
                ...
                <div class="border-t border-slate-100 pt-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <span class="text-slate-400 block text-xs font-semibold uppercase tracking-wider font-bold mb-1">Kesesuaian Bidang dengan MK</span>
                        <span class="font-semibold uppercase text-xs px-2 py-0.5 rounded-full inline-block mt-0.5" :class="detailData.kesesuaian_bidang === 'sesuai' ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700'" x-text="detailData.kesesuaian_bidang === 'sesuai' ? 'Sesuai' : 'Tidak Sesuai'"></span>
                    </div>
                </div>
