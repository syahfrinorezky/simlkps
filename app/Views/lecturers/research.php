...
<div class="space-y-6">
    ...
    <div class="flex flex-row items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs sm:text-sm text-slate-500 mt-0.5 hidden sm:block">Jumlah Judul Penelitian Dosen Tetap Program Studi</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
            <h3 class="font-bold text-slate-800 text-sm">Input Jumlah Judul Penelitian DTPS</h3>
        </div>
        
        <form action="<?= base_url('lecturers/research-performance/store') ?>" method="POST"
            x-data="{
                summary: {
